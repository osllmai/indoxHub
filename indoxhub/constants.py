...
# Resemble AI endpoints (all nested under /resemble)
RESEMBLE_PREFIX = "resemble"
RESEMBLE_TTS_SYNTHESIZE = "resemble/tts/synthesize"
RESEMBLE_TTS_VOICES = "resemble/tts/voices"
RESEMBLE_VOICES = "resemble/voices"
RESEMBLE_VOICE_DESIGN = "resemble/voice-design"
RESEMBLE_STT = "resemble/stt"
RESEMBLE_ENHANCE = "resemble/enhance"
RESEMBLE_EDIT = "resemble/edit"
RESEMBLE_DETECT = "resemble/detect"
RESEMBLE_INTELLIGENCE = "resemble/intelligence"
RESEMBLE_TRACING = "resemble/tracing"
RESEMBLE_WATERMARK = "resemble/watermark"
RESEMBLE_IDENTITY = "resemble/identity"
RESEMBLE_PROJECTS = "resemble/projects"
RESEMBLE_AGENTS = "resemble/agents"
RESEMBLE_AGENT_TOOLS = "resemble/agent-tools"
RESEMBLE_AGENT_WEBHOOKS = "resemble/agent-webhooks"
RESEMBLE_KNOWLEDGE_BASE = "resemble/knowledge-base"
RESEMBLE_UPLOADS = "resemble/uploads"
